class Admin::Poll::OfficerAssignmentsController < Admin::BaseController
  ...
  def create
    ...
    notice = if @officer_assignment.save
               t("admin.poll_officer_assignments.flash.create")
             else
               t("admin.poll_officer_assignments.flash.error_create")
             end
  ...
  def destroy
    ...
    notice = if @officer_assignment.destroy
               t("admin.poll_officer_assignments.flash.destroy")
             else
               t("admin.poll_officer_assignments.flash.error_destroy")
             end
